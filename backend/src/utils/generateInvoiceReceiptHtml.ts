...
<html>
  ...
  <body>
    <div class="container">
      <div class="header">
        <div>
          <div class="brand">Bendonalds International Schools Calabar</div>
      ...
      <div class="section">
        ...
        <div><strong>Term/Session:</strong> ${escapeHtml(inv.term)} / ${escapeHtml(inv.session)}</div>
